...
<script src="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js"></script>
 ...
 <section class="content white_background products_container">
  <div class="row">
   <div class="col-xs-12">
     ...
     <div class="products_container_top">
       <p class="products_container_title">Додавання купона</p>
  ...
  <div class="playlist__managment--item__right">
    ...
    <?=  $this->Form->control('name',array('label' => 'First Name','class'=>'form-control','required'=>'required','type'=>'text'));?>
    </div>
  </div>
</div>
       <div class="playlist__managment--item">
  ...
  <div class="playlist__managment--item__right">
    <div class="playlist--item--sub">
    <?=  $this->Form->control('discount',array('label' => 'First Name','class'=>'form-control','required'=>'required'));?>
