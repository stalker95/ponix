...
<script src="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js"></script>
 <section class="content white_background products_container">
  <div class="row">
   <div class="col-xs-12">
        <?= $this->Form->create($liqpay,['type' => 'file']); ?>

     <div class="products_container_top">
       <p class="products_container_title">Редагування Liqpay</p>
  ...
  <div class="playlist__managment--item__right">
    ...
    <?=  $this->Form->control('private_key',array('label' => 'First Name','class'=>'form-control','required'=>'required'));?>
...
<div class="product_container_item" style="display: block;">
  ...
  <div class="playlist__managment--item__right">
    <div class="playlist--item--sub">
    <?=  $this->Form->control('public_key',array('label' => 'First Name','class'=>'form-control','required'=>'required'));?>
